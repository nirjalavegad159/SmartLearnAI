...
//   /* ------------------ 4. Save progress every 2 seconds ------------------ */
//   let lastSaveTime = 0;
//   const handleTimeUpdate = () => {
//     const now = Date.now();
//     if (now - lastSaveTime < 2000) return; // save every 2 seconds
//     lastSaveTime = now;
...
//             controls
//             ref={videoRef}
//             onLoadedMetadata={handleLoadProgress}
...
//             .map((data) => (
//               <Link to={`/coursedetail/${data.course_id}`} key={data.course_id}
...
//         {/* VIDEO */}
//         <div className="w-full bg-black rounded-xl shadow overflow-hidden" style={{maxWidth:"1000px"}}>
